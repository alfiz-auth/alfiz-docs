...
<Note>
  [Permission metrics](/enforcement/metrics) are a different feature with a confusingly similar name. Metering counts work Alfiz Cloud performed; metrics count checks *your application* performed. Metrics stay where they are produced — in your process, your metrics stack, and your database. Alfiz Cloud never receives them and cannot bill on them.
</Note>
