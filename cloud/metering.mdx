...
<Note>
  If you enable usage metrics, aggregate check telemetry flows up as observability *for you*: opt-in, yours to read over the API, and never an input to your bill. Turning it off changes what you can see about your own deployment and changes nothing about what you pay.
</Note>
