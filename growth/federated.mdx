...
If your Application is already linked to Alfiz Cloud, promotion to federation is the typical path — the connection is already established, and promotion adds only the authority transfer.
