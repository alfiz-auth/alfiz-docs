---
title: "Alfiz Changelog: Every Release from 0.2.0 to 0.7.0"
sidebarTitle: "Changelog"
description: "Every Alfiz release, from 0.2.0 to 0.7.0. What shipped, what changed, and what broke across @alfiz/core, @alfiz/application, @alfiz/prisma, and @alfiz/verify."
---
...
This release answers an external enterprise-readiness review. The theme throughout: things that were possible are now *declared*, things that were the integrator's silent obligation are now *detected*, and the safe configuration is now the *default* one.
