---
title: "Alfiz Changelog: Every Release from 0.2.0 to 0.6.0"
sidebarTitle: "Changelog"
description: "Every Alfiz release, from 0.2.0 to 0.6.0. What shipped, what changed, and what broke across @alfiz/core, @alfiz/application, @alfiz/prisma, and @alfiz/verify."
---
...
- Enforced on `can`, `canAny`, `require*`, `explain`, `grantedScopes`, `holdsAnywhere` (renamed `holds` later — see Unreleased), and every snapshot equivalent. Typed keys and `alfiz-verify` already covered literal call sites; this covers the runtime-string paths they cannot see — nav tables, config, generic wrappers.
