...
- **The decision.** Always re-evaluated.
- **Grant expiry.** Evaluated against the clock at check time.
- **Active status.** An inactive principal evaluates to no access on every check shape, immediately.
