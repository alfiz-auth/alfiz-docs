...
import { createAlfizClient, otelMetricsObserver } from "@alfiz-auth/core";
...
```ts
import { createMetricsAggregator } from "@alfiz-auth/core";
...
Metrics stay in the deployment that produced them. The client hands batches to your own Application, and nothing carries them further — Alfiz Cloud never receives them, and check volume is not a billing dimension in any tier. If you want the numbers somewhere central, the observer stream is how you send them there, to the destination you choose.
