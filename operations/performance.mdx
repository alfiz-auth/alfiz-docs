...
**The epoch adds one single-row read per revalidation window** per process, a constant cost independent of every size above. See [Caching & staleness](/enforcement/caching).
