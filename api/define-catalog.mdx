...
description: "defineCatalog(input) builds a typed catalog — source of truth for permission keys, scope types, navigation, and compile-time KeyOf/PatternOf unions."
---
