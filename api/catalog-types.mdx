...
<ParamField body="label" type="string" optional>
  Short human-facing name for pickers and checkboxes, e.g. `"Publish file"`. Falls back to the permission name when absent. Keep it brief — the `description` field carries longer help text.
</ParamField>
