---
title: "alfiz-verify CLI Reference"
sidebarTitle: "alfiz-verify"
description: "alfiz-verify is the static verification CLI for Alfiz. It checks typed keys, coverage, gate shapes, and catalog validity — run it in CI to catch ungated surfaces."
---
