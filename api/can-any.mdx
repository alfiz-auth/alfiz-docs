...
sidebarTitle: "canAny()"
description: "canAny(principal, pattern) tests whether a principal holds any permission matching a pattern. Visibility affordance only, and never an authorization gate."
---
